...
public class GlobalExceptionHandler {
    ...
    private ApiRestResponse handleBindingResult(BindingResult result) {
        ...
        if (list.size() == 0) {
            return ApiRestResponse.error(AlibabaTaobaoExceptionEnum.REQUEST_PARAM_ERROR);
        }
        return ApiRestResponse.error(AlibabaTaobaoExceptionEnum.REQUEST_PARAM_ERROR.getCode(), list.toString());
    }
}
